...
class SensorData {
  ...
  final String moistureStatus; // Tambahkan property ini jika belum ada
  ...
  SensorData({
    ...
    required this.moistureStatus, // Tambahkan parameter ini juga
  });
  ...
  factory SensorData.empty() {
    return SensorData(
      ...
      pumpDuration: 0,
      pumpRemainingTime: 0,
      moistureStatus: "DRY", // Default status
    );
  }
  ...
  factory SensorData.fromMap(Map<String, dynamic> map) {
    ...
    return SensorData(
      ...
      moistureStatus: map['moisture_status'] ?? "DRY", // Pastikan ini ada
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'moisture_status': moistureStatus, // Pastikan ini ada
    };
  }
